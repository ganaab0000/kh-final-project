		...
		<c:forEach items="${reserve}" var="reserve">
			<table>
				<tbody>
					...
					<tr>
						<td rowspan="2">수령인</td>
						<td>${reserve.receiverName}</td>
					</tr>
					<tr><td></td></tr>
					<tr>
						<td rowspan="2">연락처</td>
						<td>${reserve.receiverPhone}</td>
					</tr>
					<tr><td></td></tr>
					<tr>
						<td rowspan="2">배송지</td>
						<td>${reserve.receiverAddress}</td>
					</tr>
					<tr><td></td></tr>
					<tr>
						<td rowspan="2">배송시 요청사항</td>
						<td>${reserve.requestForDelivery}</td>
					</tr>
					<tr><td></td></tr>
					...
					<tr><td><br></td><td><br></td></tr>
					<tr>
						<td rowspan="2"><form method="get" action="/reserve/edit/{id}">
							<input type="hidden" name="reserveId" value="${reserve.id}">
							<input type="submit" id="editBtn" value="배송지 변경">
						</form></td>
						<td rowspan="2"><form method="post" action="/reserve/cancel">
							<input type="hidden" name="id" value="${reserve.id}">
							<input type="submit" id="cancelBtn" value="예약 취소">
						</form></td>
					</tr>
					<tr><td></td><td></td></tr>
				</tbody>
