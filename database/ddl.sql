...
CREATE TABLE "FILE_PROJECT"(
    ...
    CONSTRAINT "FILE_PROJECT_PK" PRIMARY KEY ("FILE_ID", "PROJECT_ID")
);
...
-- ALTER TABLE "COUPON" ADD CONSTRAINT "COUPON_PK" PRIMARY KEY ( "ID" );
...
CREATE TABLE "MEMBER_COUPON" (
    ...
    CONSTRAINT "MEMBER_COUPON_PK" PRIMARY KEY ("MEMBER_ID", "COUPON_ID")
);
...
ALTER TABLE "MEMBER" ADD CONSTRAINT "FK_MEM_TO_FILE_1" FOREIGN KEY ( "PROFILE_IMG" ) REFERENCES "FILE" ( "ID" );
ALTER TABLE "FILE" ADD CONSTRAINT "FILE_TO_MEM_1_FK" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
