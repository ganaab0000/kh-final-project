...
-- ALTER TABLE "NOTIFICATION" ADD CONSTRAINT "NOTIFICATION_ID_PK" PRIMARY KEY ( "ID" );
...
--	"ID" NUMBER NOT NULL,
	...
	"PROVIDER_PROFILE_IMG" VARCHAR2(4000)
--    CONSTRAINT "OAUTH_ID_PK" PRIMARY KEY ("ID")
);
...
CREATE TABLE "CONFIRM_EMAIL" (
    ...
    CONSTRAINT "CONFIRM_EMAIL_PK" PRIMARY KEY ("MEMBER_ID")
);
...
-- ALTER TABLE "UPLOAD_FILE" ADD CONSTRAINT "FILE_PK" PRIMARY KEY ( "ID" );
DROP SEQUENCE "UPLOAD_FILE_ID_SEQ";
CREATE SEQUENCE "UPLOAD_FILE_ID_SEQ";
CREATE TABLE "FILE_PROJECT"(
	"UPLOAD_FILE_ID" NUMBER NOT NULL,
	"PROJECT_ID" NUMBER NOT NULL,
    CONSTRAINT "FILE_PROJECT_PK" PRIMARY KEY ("UPLOAD_FILE_ID", "PROJECT_ID")
);
CREATE TABLE "ROLE_CATEGORY" (
	"ID" NUMBER NOT NULL,
	"NAME" VARCHAR2(100) NOT NULL,
    CONSTRAINT "ROLE_CATEGORY_PK" PRIMARY KEY ("ID")
);
...
COMMENT ON COLUMN "ROLE_CATEGORY"."NAME" IS '권한 종류 - 모든/대시보드/프로젝트/계정/공지사항';
CREATE TABLE "MEMBER_ROLE_CATEGORY" (
	"MEMBER_ID" NUMBER NOT NULL,
	"ROLE_CATEGORY_ID" NUMBER NOT NULL,
    CONSTRAINT "MEMBER_ROLE_CATEGORY_PK" PRIMARY KEY ("MEMBER_ID", "ROLE_CATEGORY_ID")
);
...
--     CONSTRAINT "AUTO_LOGIN_PK" PRIMARY KEY ("MEMBER_ID")
-- );
CREATE TABLE "RESERVE_STATUS_CATEGORY" (
	"ID" NUMBER NOT NULL,
	"DETAIL" VARCHAR2(100) NOT NULL,
    CONSTRAINT "RESERVE_STATUS_CATEGORY_PK" PRIMARY KEY ("ID")
);
...
CREATE TABLE "MEMBER" (
	...
	"IS_BLOCKED" VARCHAR2(1) DEFAULT 'N' NOT NULL,
	"DATE_LOGGEDIN" DATE DEFAULT SYSDATE NOT NULL,
	"DATE_CREATED" DATE	DEFAULT SYSDATE	NOT NULL,
	"DATE_UPDATED" DATE	DEFAULT SYSDATE	NOT NULL,
	"DATE_DELETED" DATE	DEFAULT SYSDATE	NOT NULL,
	"DATE_BLOCKED" DATE	DEFAULT SYSDATE	NOT NULL,
...
CREATE TABLE "PROJECT_STATUS_CATEGORY" (
	"ID" NUMBER NOT NULL,
	"DETAIL" VARCHAR2(100) NOT NULL,
    CONSTRAINT "PROJECT_STATUS_CATEGORY_PK" PRIMARY KEY ("ID")
);
...
CREATE TABLE "RESERVE_REWARD" (
    ...
    CONSTRAINT "RESERVE_REWARD_PK" PRIMARY KEY ("RESERVE_ID", "REWARD_ID")
);
-- ALTER TABLE "RESERVE_REWARD" ADD CONSTRAINT "RESERVE_REWARD_PK" PRIMARY KEY ( "RESERVE_ID", "REWARD_ID" );
CREATE TABLE "RESERVE" (
	...
	"RESERVE_STATUS_CATEGORY_ID" NUMBER NOT NULL,
	"MEMBER_ID" NUMBER NOT NULL,
...
CREATE TABLE "COMMUNITY_CATEGORY" (
	"ID" NUMBER NOT NULL,
	"NAME" VARCHAR2(100) NOT NULL,
    CONSTRAINT "COMMUNITY_CATEGORY_PK" PRIMARY KEY ("ID")
);
-- ALTER TABLE "COMMUNITY_CATEGORY" ADD CONSTRAINT "COMMUNITY_CATEGORY_PK" PRIMARY KEY ( "ID" );
...
CREATE TABLE "FOLLOW" (
    ...
    CONSTRAINT "FOLLOW_PK" PRIMARY KEY ( "FOLLOW", "FOLLOWER" )
);
-- ALTER TABLE "FOLLOW" ADD CONSTRAINT "FOLLOW_PK" PRIMARY KEY ( "FOLLOW", "FOLLOWER" );
CREATE TABLE "VOTE" (
	"MEMBER_ID" NUMBER NOT NULL,
	"PROJECT_ID" NUMBER NOT NULL,
    CONSTRAINT "VOTE_PK" PRIMARY KEY ( "MEMBER_ID", "PROJECT_ID" )
);
...
CREATE TABLE "BLAME" (
	...
	"PROJECT_ID" NUMBER NOT NULL,
	"MEMBER_ID" NUMBER NOT NULL,
    CONSTRAINT "BLAME_PK" PRIMARY KEY ("ID")
);
...
CREATE TABLE "BLAME_REPLY" (
	...
	"MEMBER_ID" NUMBER NOT NULL,
    CONSTRAINT "BLAME_REPLY_PK" PRIMARY KEY ("ID")
);
...
CREATE TABLE "QNA" (
    "ID" NUMBER NOT NULL,
    "HEADER" VARCHAR2(256) NOT NULL CHECK("HEADER" IN('후원자', '창작자', '일반')),
    "EMAIL" VARCHAR2(100) NOT NULL,
    "TITLE" VARCHAR2(300) NOT NULL,
    "CONTENT" CLOB NOT NULL,
    "PATH" VARCHAR2(300) NOT NULL,
    "DATE_CREATED" DATE DEFAULT SYSDATE	NOT NULL,
    "IS_CONSENT" VARCHAR2(1) DEFAULT 'Y' NOT NULL,
    "IS_STATE" VARCHAR2(1) DEFAULT 'N'	NOT NULL,
    "IS_DELETED" VARCHAR2(1) DEFAULT 'N'	NOT NULL,
...
CREATE TABLE "VISITOR_PER_DAY" (
	...
	"MEMBER_ID" NUMBER NOT NULL,
    CONSTRAINT "VISITOR_PER_DAY_PK" PRIMARY KEY ( "DATE_VISITED", "MEMBER_ID" )
);
...
CREATE TABLE "VISITOR_COUNT_PER_DAY" (
    ...
    CONSTRAINT "VISITOR_COUNT_PER_DAY_PK" PRIMARY KEY ("DATE_VISITED")
);
...
ALTER TABLE "FILE_PROJECT" ADD CONSTRAINT "FK_FILE_PJT_TO_FILE_1" FOREIGN KEY ( "UPLOAD_FILE_ID" ) REFERENCES "UPLOAD_FILE" ( "ID" );
...
ALTER TABLE "COMMUNITY" ADD CONSTRAINT "COMM_TO_COMM_1_FK" FOREIGN KEY ( "PARENT_COMMUNITY_ID" ) REFERENCES "COMMUNITY" ( "ID" );
ALTER TABLE "NOTIFICATION" ADD CONSTRAINT "NOTI_TO_MEM_1_FK" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "MEMBER" ADD CONSTRAINT "FK_MEM_TO_FILE_1" FOREIGN KEY ( "PROFILE_IMG" ) REFERENCES "UPLOAD_FILE" ( "ID" );
-- ALTER TABLE "UPLOAD_FILE" ADD CONSTRAINT "FILE_TO_MEM_1_FK" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "CONFIRM_EMAIL" ADD CONSTRAINT "EMAIL_TO_MEM_1_FK" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "OAUTH" ADD CONSTRAINT "OAUTH_TO_MEM_1_FK" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );
ALTER TABLE "RESERVE" ADD CONSTRAINT "RSV_TO_RSV_STS_CAT_1_FK" FOREIGN KEY ( "RESERVE_STATUS_CATEGORY_ID" ) REFERENCES "RESERVE_STATUS_CATEGORY" ( "ID" );
-- ALTER TABLE "AUTO_LOGIN" ADD CONSTRAINT "FK_MEM_TO_AUTO_LOGIN_1" FOREIGN KEY ( "MEMBER_ID" ) REFERENCES "MEMBER" ( "ID" );


ALTER TABLE RESERVE ADD(PROJECT_ID NUMBER NOT NULL);
ALTER TABLE "RESERVE" ADD CONSTRAINT "FK_MEM_TO_RESERVE_2" FOREIGN KEY ( "PROJECT_ID" ) REFERENCES "PROJECT" ( "ID" );
